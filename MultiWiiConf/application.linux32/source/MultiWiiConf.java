...
int Centerlimits[] = {
  1200, 1800
}; // Endpoints of ServoCenterSliders 

cGraph g_graph;
int windowsX = 1000;
int windowsY = 550 + tabHeight;
int xGraph = 10;
...
public void create_ServoGraphics() {
  ...
  if (multiType == FLYING_WING || multiType == TRI || multiType == BI || multiType == DUALCOPTER || multiType == SINGLECOPTER) { //ServoGraphics For FlyingWng & TRI & BI || multiType == DUALCOPTER
    ...
    if (multiType == DUALCOPTER) {
      ...
      TxtLeftW = controlP5.addTextlabel("Label", "\u526f\u7ffc").setPosition(xServ + 110, yServ + 40).hide().moveTo("ServoSettings");
  ...
  if (multiType == HELI_120_CCPM || multiType == HELI_90_DEG) {
    ...
    TxtMIX[5] = controlP5.addTextlabel("mix6", "\u526f\u7ffc").setPosition(XPos - 115, YPos + 30).moveTo("ServoSettings");
    for (i = 0; i < 6; i++) {
      TxtMIX[i].hide();
    }
  ...
  for (i = 0; i < 8; i++) { // TODO Something
    ...
    RateSlider[i].setColorBackground(yellow_);
    RateSlider[i].setDirection(Controller.HORIZONTAL);
    RateSlider[i].setDecimalPrecision(0);
    RateSlider[i].setMultiplier(1);
    RateSlider[i].setMin(0).setMax(125).hide().moveTo("ServoSettings");
  }
...
public void setup() {
  ...
  if (P3D == OPENGL) pVersion = 2.0f;
  else pVersion = 1.5f;

  size(windowsX, windowsY, OPENGL);
  frameRate(20);

  font8 = createFont("sans-serif", 8, false);
  font9 = createFont("sans-serif", 9, false);
  font12 = createFont("sans-serif", 12, false);
  font15 = createFont("sans-serif", 15, false);
  ...
  baudListbox.captionLabel().set("\u6ce2\u7279\u7387");
  ...
  commListbox.captionLabel().set("\u63a5\u53e3");
  ...
  commListbox.addItem("\u5173\u95ed\u901a\u8baf", ++commListMax); // addItem(name,value)
  // text label for which comm port selected
  txtlblWhichcom = controlP5.addTextlabel("txtlblWhichcom", "\u6ca1\u6709\u9009\u62e9\u7aef\u53e3", 5, 65 + tabHeight); // textlabel(name,text,x,y)
  ...
  TxtInfo1 = controlP5.addTextlabel("xInf", "\u7070\u8272\u7684\u503c\u9700\u8981\u5728config.h\u91cc\u5b9a\u4e49!!").setPosition(xServ + 0, yServ + 210).moveTo("Config");
  TxtInfo2 = controlP5.addTextlabel("gInf", "\u7eff\u8272\u7684\u503c\u4fee\u6539\u4e4b\u540e\u9700\u8981\u70b9\u51fb\u5199\u5165\u624d\u80fd\u4fdd\u5b58!!").setPosition(xServ + 0, yServ + 190).moveTo("Config");
  ...
  Links = controlP5.addTextlabel("LinkInf", "\u4e00\u4e9b\u7528\u5f97\u5230\u7684\u7f51\u7ad9!!").setPosition(xServ + 100, yServ + 20).moveTo("Config");
  ...
  buttonSAVE = controlP5.addButton("bSAVE", 1, 5, 45 + tabHeight, 40, 19).setLabel("\u4fdd\u5b58").setColorBackground(red_);
  buttonIMPORT = controlP5.addButton("bIMPORT", 1, 50, 45 + tabHeight, 40, 19).setLabel("\u52a0\u8f7d").setColorBackground(red_);

  btnQConnect = controlP5.addButton("bQCONN", 1, xGraph + 0, yGraph - 105, 100, 19).setLabel("\u91cd\u65b0\u8fde\u63a5").setColorBackground(red_);
  buttonSTART = controlP5.addButton("bSTART", 1, xGraph + 110, yGraph - 25, 45, 19).setLabel("\u5f00\u59cb").setColorBackground(red_);
  buttonSTOP = controlP5.addButton("bSTOP", 1, xGraph + 160, yGraph - 25, 45, 19).setLabel("\u505c\u6b62").setColorBackground(red_);

  buttonAcc = controlP5.addButton("bACC", 1, xButton, yButton, 45, 15).setColorBackground(red_).setLabel("\u52a0\u901f\u5ea6");
  buttonBaro = controlP5.addButton("bBARO", 1, xButton + 50, yButton, 45, 15).setColorBackground(red_).setLabel("\u6c14\u538b");
  buttonMag = controlP5.addButton("bMAG", 1, xButton + 100, yButton, 45, 15).setColorBackground(red_).setLabel("\u78c1\u963b");
  buttonGPS = controlP5.addButton("bGPS", 1, xButton, yButton + 17, 45, 15).setColorBackground(red_).setLabel("\u5b9a\u4f4d");
  buttonSonar = controlP5.addButton("bSonar", 1, xButton + 50, yButton + 17, 45, 15).setColorBackground(red_).setLabel("\u58f0\u5450");
  buttonOptic = controlP5.addButton("bOptic", 1, xButton + 100, yButton + 17, 45, 15).setColorBackground(grey_).setLabel("\u89c6\u89c9");
  ...
  controlP5.addTextlabel("alarmLabel", "\u8b66\u62a5:", xGraph - 5, yGraph - 32);

  controlP5.addTextlabel("acclabel", "\u901f\u5ea6", xo, y1 - 4);
  controlP5.addTextlabel("accrolllabel", "   \u526f\u7ffc", xo, y1 + 10).setFont(font9);
  controlP5.addTextlabel("accpitchlabel", "   \u5347\u964d\u8235", xo, y1 + 20).setFont(font9);
  controlP5.addTextlabel("acczlabel", "   \u4e0a\u4e0b", xo, y1 + 30).setFont(font9);
  controlP5.addTextlabel("gyrolabel", "\u9640\u87ba", xo, y2 - 4);
  controlP5.addTextlabel("gyrorolllabel", "   \u526f\u7ffc", xo, y2 + 10).setFont(font9);
  controlP5.addTextlabel("gyropitchlabel", "   \u5347\u964d\u8235", xo, y2 + 20).setFont(font9);
  controlP5.addTextlabel("gyroyawlabel", "   \u65b9\u5411\u8235", xo, y2 + 30).setFont(font9);
  controlP5.addTextlabel("maglabel", "\u78c1\u963b", xo, y5 - 4);
  controlP5.addTextlabel("magrolllabel", "   \u526f\u7ffc", xo, y5 + 10).setFont(font9);
  controlP5.addTextlabel("magpitchlabel", "   \u5347\u964d\u8235", xo, y5 + 20).setFont(font9);
  controlP5.addTextlabel("magyawlabel", "   \u65b9\u5411\u8235", xo, y5 + 30).setFont(font9);
  controlP5.addTextlabel("altitudelabel", "\u6c14\u538b", xo, y3 - 4);
  controlP5.addTextlabel("headlabel", "\u65b9\u5411", xo, y4 - 4);
  ...
  buttonREAD = controlP5.addButton("READ", 1, xParam + 5, yParam + 260, 50, 16).setColorBackground(red_).setLabel("\u8bfb\u53d6");
  buttonRESET = controlP5.addButton("RESET", 1, xParam + 60, yParam + 260, 60, 16).setColorBackground(red_).setLabel("\u91cd\u7f6e");
  buttonWRITE = controlP5.addButton("WRITE", 1, xParam + 290, yParam + 260, 50, 16).setColorBackground(red_).setLabel("\u5199\u5165");
  ...
  buttonCALIBRATE_ACC = controlP5.addButton("CALIB_ACC", 1, xParam + 210, yParam + 260, 70, 16).setColorBackground(red_).setLabel("\u6821\u51c6\u52a0\u901f\u5ea6\u8ba1");
  buttonCALIBRATE_MAG = controlP5.addButton("CALIB_MAG", 1, xParam + 130, yParam + 260, 73, 16).setColorBackground(red_).setLabel("\u6821\u51c6\u78c1\u963b");
  buttonSETTING = controlP5.addButton("SETTING", 1, xParam + 410, yParam + 260, 105, 16).setColorBackground(red_).setLabel("\u9009\u62e9\u8bbe\u7f6e"); //.hide();
  ...
  TX_StickSlider[RCThro] = controlP5.addSlider("\u6cb9\u95e8", 900, 2100, 1500, xRC, yRC, 100, 10).setDecimalPrecision(0);
  TX_StickSlider[RCRoll] = controlP5.addSlider("\u526f\u7ffc", 900, 2100, 1500, xRC, yRC + 15, 100, 10).setDecimalPrecision(0);
  TX_StickSlider[RCPitch] = controlP5.addSlider("\u5347\u964d\u8235", 900, 2100, 1500, xRC, yRC + 30, 100, 10).setDecimalPrecision(0);
  TX_StickSlider[RCYaw] = controlP5.addSlider("\u65b9\u5411\u8235", 900, 2100, 1500, xRC, yRC + 45, 100, 10).setDecimalPrecision(0);
  TX_StickSlider[RCAUX1] = controlP5.addSlider("\u901a\u90531", 1000, 2000, 1500, xRC, yRC + 60, 100, 10).setDecimalPrecision(0);
  TX_StickSlider[RCAUX2] = controlP5.addSlider("\u901a\u90532", 1000, 2000, 1500, xRC, yRC + 75, 100, 10).setDecimalPrecision(0);
  TX_StickSlider[RCAUX3] = controlP5.addSlider("\u901a\u90533", 1000, 2000, 1500, xRC, yRC + 90, 100, 10).setDecimalPrecision(0);
  TX_StickSlider[RCAUX4] = controlP5.addSlider("\u901a\u90534", 1000, 2000, 1500, xRC, yRC + 105, 100, 10).setDecimalPrecision(0);
...
public void evaluateCommand(byte cmd, int dataSize) {
  ...
  case MSP_STATUS:
    ...
    for (i = 0; i < CHECKBOXITEMS; i++) {
      if ((mode & (1 << i)) > 0) buttonCheckbox[i].setColorBackground(green_);
      else buttonCheckbox[i].setColorBackground(red_);
    }
  ...
  case MSP_ANALOG:
    ...
    pMeterSum = read16();
    rssi = read16();
    if (rssi != 0) VBat[5].setValue(rssi).show(); // rssi
  ...
  case MSP_PID:
    for (i = 0; i < PIDITEMS; i++) {
      ...
      switch (i) {
      case 0:
        confP[i].setValue(byteP[i] / 10.0f);
        confI[i].setValue(byteI[i] / 1000.0f);
      ...
      case 4:
        confP[i].setValue(byteP[i] / 100.0f);
        confI[i].setValue(byteI[i] / 100.0f);
        confD[i].setValue(byteD[i] / 1000.0f);
        break;
      case 5:
        confP[i].setValue(byteP[i] / 10.0f);
        confI[i].setValue(byteI[i] / 100.0f);
  ...
  case MSP_SERVO_CONF:
    ...
    if (multiType == AIRPLANE) { // Airplane OK
      if (flaps) {
        ...
        if (ServoMID[2] == 4) {
          Cau0();
        } else if (ServoMID[2] == 5) {
          Cau1();
        } else if (ServoMID[2] == 6) {
          Cau2();
        } else if (ServoMID[2] == 7) {
          Cau3();
        } else {
          CauClear();
        }
      ...
      for (i = 0; i < 8; i++) {
        ...
        if (servoRATE[i] > 127) { // Reverse/Rate servos
          Bbox.deactivate(i);
          RateSlider[i].setValue(abs(servoRATE[i] - 256));
        } else {
          Bbox.activate(i);
          RateSlider[i].setValue(abs(servoRATE[i]));
        }
      }
      ...
      for (i = 0; i < 8; i++) { //Update sliders
        ...
        if (servoRATE[i] > 127) { // Reverse/Rate servos
          wingDir[i] = -1;
          RateSlider[i].setValue((servoRATE[i] - 256));
        } else {
          wingDir[i] = 1;
          RateSlider[i].setValue(abs(servoRATE[i]));
        } // Servo Direction
    ...
    if (gimbal) {
      ...
      if (ServoMID[0] > 1200) {
        GimbalSlider[2].setMin(1200).setMax(1700);
      } else {
        GimbalSlider[2].setMin(0).setMax(12);
      }
      if (ServoMID[1] > 1200) {
        GimbalSlider[6].setMin(1200).setMax(1700);
      } else {
        GimbalSlider[6].setMin(0).setMax(12);
      }
      if (ServoMID[2] > 1000) {
        GimbalSlider[10].setMin(1000).setMax(30000);
      } else {
        GimbalSlider[10].setMin(0).setMax(12);
      }
      ...
      if (servoRATE[i] > 127) {
        GimbalSlider[3].setValue((servoRATE[i] - 256));
      } else {
        GimbalSlider[3].setValue(abs(servoRATE[i]));
      }
      ...
      if (servoRATE[i] > 127) {
        GimbalSlider[7].setValue((servoRATE[i] - 256));
      } else {
        GimbalSlider[7].setValue(abs(servoRATE[i]));
      }
    ...
    if (camTrigger) {
      if (ServoMID[2] > 1200) {
        ServoSliderC[2].setMin(Centerlimits[0]).setMax(Centerlimits[1]);
      } else {
        ServoSliderC[2].setMin(0).setMax(12);
      }
    }
  ...
  case MSP_MISC:
    ...
    // LOG_PERMANENT        
    MConf[4] = read16();
    confINF[4].setValue((int) MConf[4]); //f
    MConf[5] = read32();
    confINF[5].setValue((int) MConf[5]); //g        
    for (i = 1; i < 3; i++) {
      confINF[i].setColorBackground(grey_).setMin((int) MConf[i]).setMax((int) MConf[i]);
    } //?
    ...
    //mag_decliniation
    MConf[6] = read16();
    confINF[6].setValue((float) MConf[6] / 10).show(); //h
    if (!Mag_) confINF[6].hide();

    // VBAT
    int q = read8();
    if (toggleVbat) {
      VBat[0].setValue(q).setColorBackground(green_);
      toggleVbat = false; // i
      for (i = 1; i < 4; i++) VBat[i].setValue(read8() / 10.0f).setColorBackground(green_);
    } // j,k,l
    if (q > 1)
      for (i = 0; i < 5; i++) VBat[i].show();
...
public void draw() {
  ...
  if (init_com == 1 && graph_on == 1) {
    ...
    if ((time - time4) > 40) {
      ...
      altData.addVal(alt);
      headData.addVal(head);
      debug1Data.addVal(debug1);
      debug2Data.addVal(debug2);
      debug3Data.addVal(debug3);
      debug4Data.addVal(debug4);
    }
    ...
    if (!toggleRead && !toggleWrite && !toggleSetSetting) {
      if ((time - time2) > 40) {
        time2 = time;
        int[] requests = {
          MSP_STATUS, MSP_RAW_IMU, MSP_SERVO, MSP_MOTOR, MSP_RC, MSP_DEBUG
        };
      ...
      if ((time - time6) > 200) {
        time6 = time;
        int[] requests = {
          MSP_RAW_GPS, MSP_COMP_GPS, MSP_ANALOG
        };
        sendRequestMSP(requestMSP(requests));
        ...
        if (toggleMotor) {
          ...
          for (i = 0; i < 8; i++) {
            if (motToggle[i].getState()) {
              payload.add(PApplet.parseChar(PApplet.parseInt(motorControlSlider.getValue()) % 256));
              payload.add(PApplet.parseChar(PApplet.parseInt(motorControlSlider.getValue()) / 256));
            } else {
              payload.add(PApplet.parseChar(1000 % 256));
              payload.add(PApplet.parseChar(1000 / 256));
            }
          }
    ...
    if (toggleRead) {
      if (!toggleLive && (ActiveTab == "default" || ActiveTab == "Config")) { // && ActiveTab=="default".. Because of checksum error on MSP_PID with servosTab
        int[] requests = {
          MSP_IDENT, MSP_BOXNAMES, MSP_RC_TUNING, MSP_PID, MSP_MOTOR_PINS, MSP_BOX, MSP_MISC
        }; // MSP_PIDNAMES, MSP_SERVO_CONF
        sendRequestMSP(requestMSP(requests));
      }
    ...
    if ((toggleWriteServo || toggleWriteServoLive) && !toggleRead) { // MSP_SET_SERVO_CONF
      ...
      if (multiType == AIRPLANE || multiType == PPM_TO_SERVO || multiType == HELI_120_CCPM || multiType == HELI_90_DEG) {
        for (i = 0; i < 8; i++) {
          int q = (int) ServoSliderMIN[i].value();
          payload.add(PApplet.parseChar(q % 256));
          payload.add(PApplet.parseChar(q / 256)); // Min
          q = (int) ServoSliderMAX[i].value();
          payload.add(PApplet.parseChar(q % 256));
          payload.add(PApplet.parseChar(q / 256)); // Max
          q = (int)(ServoSliderC[i].value());
          payload.add(PApplet.parseChar(q % 256));
          payload.add(PApplet.parseChar(q / 256)); // Servo centers

          servoRATE[i] = PApplet.parseInt(RateSlider[i].value());
          if ((int) Bbox.getArrayValue()[i] == 1) {
            servoRATE[i] = abs(servoRATE[i]);
          } else {
            servoRATE[i] = abs(servoRATE[i]) * -1;
          } // Direction
          ...
          if (multiType == HELI_120_CCPM) {
            if (i == 3) {
              servoRATE[3] = (int) Mbox.getArrayValue()[2] + (int) Mbox.getArrayValue()[1] * 2 + (int) Mbox.getArrayValue()[0] * 4;
            }
            if (i == 4) {
              servoRATE[4] = (int) Mbox.getArrayValue()[5] + (int) Mbox.getArrayValue()[4] * 2 + (int) Mbox.getArrayValue()[3] * 4;
            }
            if (i == 6) {
              servoRATE[6] = (int) Mbox.getArrayValue()[8] + (int) Mbox.getArrayValue()[7] * 2 + (int) Mbox.getArrayValue()[6] * 4;
            }
            //bbb
          }
      ...
      //******************************************************************************************
        ...
        for (i = 0; i < 8; i++) {
          servoRATE[i] = round(RateSlider[i].value());
          payload.add(PApplet.parseChar(servoRATE[i]));
        } // servoRATE
        for (i = 0; i < 8; i++) {
          int q = (int)(ServoSliderC[i].value()) + 512;
          payload.add(PApplet.parseChar(q % 256));
          payload.add(PApplet.parseChar(q / 256));
        } // Servo centers...
        for (i = 0; i < 8; i++) {
          if ((int) Bbox.getArrayValue()[i] == 1) {
            payload.add(PApplet.parseChar(11));
          } else {
            payload.add(PApplet.parseChar(9));
          }
        } // Direction
      }
    ...
    if (toggleWriteWing || toggleWriteWingLive) { // MSP_SET_SERVO_CONF
      toggleWriteWing = false;
      toggleWriteWingLive = false;
      ...
      if (toggleGimbal || toggleTrigger) { // MSP_SET_SERVO_CONF
        ...
        ServoMIN[0] = (int) GimbalSlider[0].value();
        ServoMIN[1] = (int) GimbalSlider[4].value();
        ServoMIN[2] = (int) GimbalSlider[8].value();
        ServoMAX[0] = (int) GimbalSlider[1].value();
        ServoMAX[1] = (int) GimbalSlider[5].value();
        ServoMAX[2] = (int) GimbalSlider[9].value();
        ServoMID[0] = (int) GimbalSlider[2].value();
        ServoMID[1] = (int) GimbalSlider[6].value();
        ServoMID[2] = (int) GimbalSlider[10].value();
        servoRATE[0] = (int) GimbalSlider[3].value();
        servoRATE[1] = (int) GimbalSlider[7].value();
        servoRATE[2] = (int) GimbalSlider[11].value();
    ...
    if (gimbal && gimbalConfig) {
      if ((int) GimbalSlider[11].value() == 1) {
        GimbalSlider[11].setCaptionLabel("Trig_Reversed");
      } else {
        GimbalSlider[11].setCaptionLabel("Trig_Normal");
      }
      int ValLow;
      for (i = 2; i < 11; i += 4) {
        if (i > 8) {
        ...
        if (GimbalSlider[i].value() < ValLow) {
          GimbalSlider[i].setMin(0).setMax(12);
        }
        switch ((int) GimbalSlider[i].value()) {
        case 0:
          GimbalSlider[i].setCaptionLabel("\u526f\u7ffc");
          break;
        case 1:
          GimbalSlider[i].setCaptionLabel("NICK");
          break;
        case 2:
          GimbalSlider[i].setCaptionLabel("\u65b9\u5411\u8235");
          break;
        case 3:
          GimbalSlider[i].setCaptionLabel("THRO");
          break;
        case 4:
          GimbalSlider[i].setCaptionLabel("AUX1");
          break;
        case 5:
          GimbalSlider[i].setCaptionLabel("AUX2");
          break;
        case 6:
          GimbalSlider[i].setCaptionLabel("AUX3");
          break;
        case 7:
          GimbalSlider[i].setCaptionLabel("AUX4");
          break;
        case 8:
          GimbalSlider[i].setCaptionLabel("AUX5");
          break;
        case 9:
          GimbalSlider[i].setCaptionLabel("AUX6");
          break;
        case 10:
          GimbalSlider[i].setCaptionLabel("AUX7");
          break;
        case 11:
          GimbalSlider[i].setCaptionLabel("AUX8");
          break;
        default:
          GimbalSlider[i].setCaptionLabel("MID");
        }
        if (GimbalSlider[i].value() == 12) {
          GimbalSlider[i].setMin(ValLow - 1).setMax(2000);
          if (i == 10) {
            GimbalSlider[i].setMin(ValLow - 1).setMax(30000);
          }
    ...
    if (ServosActive) {
      ...
      for (i = 0; i < 8; i++) {
        if (ServoSliderC[i].value() < BreakPoint) {
          ServoSliderC[i].setMin(0).setMax(12);
        }
        switch ((int) ServoSliderC[i].value()) {
        case 0:
          ServoSliderC[i].setCaptionLabel("\u526f\u7ffc");
          break;
        case 1:
          ServoSliderC[i].setCaptionLabel("NICK");
          break;
        case 2:
          ServoSliderC[i].setCaptionLabel("\u65b9\u5411\u8235");
          break;
        case 3:
          ServoSliderC[i].setCaptionLabel("THRO");
          break;
        case 4:
          ServoSliderC[i].setCaptionLabel("AUX1");
          break;
        case 5:
          ServoSliderC[i].setCaptionLabel("AUX2");
          break;
        case 6:
          ServoSliderC[i].setCaptionLabel("AUX3");
          break;
        case 7:
          ServoSliderC[i].setCaptionLabel("AUX4");
          break;
        case 8:
          ServoSliderC[i].setCaptionLabel("AUX5");
          break;
        case 9:
          ServoSliderC[i].setCaptionLabel("AUX6");
          break;
        case 10:
          ServoSliderC[i].setCaptionLabel("AUX7");
          break;
        case 11:
          ServoSliderC[i].setCaptionLabel("AUX8");
          break;
        default:
          ServoSliderC[i].setCaptionLabel("MID");
        }
    ...
    if (toggleWrite) {
      ...
      for (i = 0; i < CHECKBOXITEMS; i++) {
        ...
        payload.add(PApplet.parseChar(activation[i] % 256));
        payload.add(PApplet.parseChar(activation[i] / 256));
      }
      ...
      payload.add(PApplet.parseChar(intPowerTrigger % 256));
      payload.add(PApplet.parseChar(intPowerTrigger / 256)); //a


      // ThrVal   minthrottle,maxthrottle,mincommand,FSthrottle   b,c,d,e
      for (i = 0; i < 4; i++) {
        int q = (int)(confINF[i].value());
        payload.add(PApplet.parseChar(q % 256));
        payload.add(PApplet.parseChar(q / 256));
      }

      // PermanentLog
      int nn = round(confINF[4].value() * 10);
      payload.add(PApplet.parseChar(nn - ((nn >> 8) << 8)));
      payload.add(PApplet.parseChar(nn >> 8)); // f


      nn = round(confINF[5].value());
      payload.add(PApplet.parseChar(nn - ((nn >> 8) << 8)));
      payload.add(PApplet.parseChar(nn >> 8)); // g 32b
      payload.add(PApplet.parseChar(nn - ((nn >> 16) << 16)));
      payload.add(PApplet.parseChar(nn >> 16));


      // MagDec
      nn = round(confINF[6].value() * 10);
      payload.add(PApplet.parseChar(nn - ((nn >> 8) << 8)));
      payload.add(PApplet.parseChar(nn >> 8)); // h


      // VBatscale
      nn = round(VBat[0].value());
      payload.add(PApplet.parseChar(nn)); // i
      for (i = 1; i < 4; i++) {
        int q = PApplet.parseInt(VBat[i].value() * 10);
        payload.add(PApplet.parseChar(q));
      } // j,k,l
  ...
  textFont(font12);
  text("\u6d77\u62d4   :", xGPS, yGPS + 15);
  text("\u7eac\u5ea6   :", xGPS, yGPS + 30);
  text("\u7ecf\u5ea6   :", xGPS, yGPS + 45);
  text("\u901f\u5ea6   :", xGPS, yGPS + 60);
  text("\u536b\u661f   :", xGPS, yGPS + 75);
  text("dist home : ", xGPS, yGPS + 90);
  // ---------------------------------------------------------------------------------------------

  text("I2C error:", xGraph + 350, yGraph - 10);
  text("\u5faa\u73af\u65f6\u95f4:", xGraph + 220, yGraph - 10);

  text("\u7535\u6e90", xGraph - 5, yGraph - 65);
  textFont(font9);

  text("   \u70b9\u538b:", xGraph - 5, yGraph - 55);
  text(bytevbat / 10.0f + " V", xGraph + 50, yGraph - 55);

  text("   \u7535\u6d41:", xGraph - 5, yGraph - 45);
  text(amperage / 10.0f + " A", xGraph + 50, yGraph - 45);

  text("   \u603b\u8ba1:", xGraph - 5, yGraph - 35);
  ...
  altSlider.setValue(alt / 100);
  headSlider.setValue(head);
  magxSlider.setValue(magx);
  magySlider.setValue(magy);
  magzSlider.setValue(magz);
  debug1Slider.setValue(debug1);
  debug2Slider.setValue(debug2);
  debug3Slider.setValue(debug3);
  debug4Slider.setValue(debug4);
  ...
  if (multiType == FLYING_WING || multiType == TRI || multiType == BI || multiType == DUALCOPTER || multiType == SINGLECOPTER) { //|| multiType == DUALCOPTER
    ...
    if (toggleWing == true) {
      ...
      if (multiType == TRI) {
        ServoSliderC[5].show();
        ServoSliderMIN[5].show();
        ServoSliderMAX[5].show();
      }
    } else {
      if (multiType != SINGLECOPTER) {
        TxtLeftW.hide();
  ...
  if (multiType == AIRPLANE || multiType == HELI_120_CCPM || multiType == PPM_TO_SERVO || multiType == HELI_90_DEG) {
    ...
    for (i = 0; i < 8; i++) {
      ...
      if (toggleServo == true) {
        ...
        if (i < 1 && flapperons) {
          ServoSliderMIN[i].show();
          ServoSliderMAX[i].show();
        }
        if (i == 2 && flaps && toggleServo) {
          ServoSliderMIN[i].show();
          ServoSliderMAX[i].show();
          TxtAux.show();
          ServoSliderC[i].show();
  ...
  if (toggleGimbal || toggleTrigger) { //if (multiType == GIMBAL)
    ...
    servoSliderH[1].setPosition(xMot, yMot + 75).setCaptionLabel("\u526f\u7ffc").show();
    servoSliderH[0].setPosition(xMot, yMot + 35).setCaptionLabel("\u5347\u964d\u8235").show();
    ...
    line(0, -size, 0, +size);
    noLights();
    text("QUADRICOPTER +", -40, -50);
    camera();
    popMatrix();

    motSlider[0].setPosition(xMot + 50, yMot + 75).setHeight(60).setCaptionLabel("\u540e").show();
    motSlider[1].setPosition(xMot + 100, yMot + 35).setHeight(60).setCaptionLabel("\u53f3").show();
    motSlider[2].setPosition(xMot, yMot + 35).setHeight(60).setCaptionLabel("\u5de6").show();
    motSlider[3].setPosition(xMot + 50, yMot - 15).setHeight(60).setCaptionLabel("\u524d").show();
    ...
    line(+size, +size, 0, 0);
    noLights();
    text("QUADRICOPTER X", -50, -70);
    camera();
    popMatrix();

    motSlider[0].setPosition(xMot + 90, yMot + 75).setHeight(60).setCaptionLabel("\u53f3\u540e").show();
    motSlider[1].setPosition(xMot + 90, yMot - 15).setHeight(60).setCaptionLabel("\u540e\u524d").show();
    motSlider[2].setPosition(xMot + 10, yMot + 75).setHeight(60).setCaptionLabel("\u5de6\u540e").show();
    motSlider[3].setPosition(xMot + 10, yMot - 15).setHeight(60).setCaptionLabel("\u5de6\u524d").show();
    ...
    line(0, 0, 1.8f * size, size);
    line(1.8f * size, size, 1.8f * size, size - 30);
    line(1.8f * size, size - 30, 0, -1.5f * size);
    line(0, 0, -1.8f * size, +size);
    line(-1.8f * size, size, -1.8f * size, +size - 30);
    line(-1.8f * size, size - 30, 0, -1.5f * size);
    noLights();
    text("FLYING WING", -40, -50);
    camera();
    popMatrix();
    ...
    line(+size, +1.2f * size, +size, -1.2f * size);
    line(-size, +1.2f * size, -size, -1.2f * size);
    line(+size, 0, 0, 0);
    line(-size, 0, 0, 0);
    noLights();
    text("HEXACOPTER H", -45, -60);
    camera();
    popMatrix();
    ...
    // Wing
    line(0, 0, Span, 0);
    line(Span, 0, Span, VingRoot);
    line(Span, VingRoot, 0, VingRoot);
    line(0, 0, -Span, 0);
    line(-Span, 0, -Span, VingRoot);
    line(-Span, VingRoot, 0, VingRoot);
    // Stab
    line(-(size * 0.4f), size, (size * 0.4f), size);
    line(-(size * 0.4f), size + 5, (size * 0.4f), size + 5);
    line(-(size * 0.4f), size, -(size * 0.4f), size + 5);
    line((size * 0.4f), size, (size * 0.4f), size + 5);
    // Body  
    line(-2, size, -2, -size + 5);
    line(2, size, 2, -size + 5);
    line(-2, -size + 5, 2, -size + 5);
    // Fin 
    line(0, size - 3, 0, 0, size, 15);
    line(0, size, 15, 0, size + 5, 15);
    line(0, size + 5, 15, 0, size + 5, 0);
    noLights();
    textFont(font12);
    text("AIRPLANE", -40, -50);
    camera();
    ...
    if (flaps) {
      BtServo[2].setLabel("Flaps").setSize(60, 12).setColorBackground(green_);
      servoSliderH[2].setPosition(xMot, yMot + 130).setCaptionLabel("Flaps").show();
    }
    if (!flaps) {
      for (i = 0; i < 3; i++) BtServo[i].setLabel("").setSize(90, 12).setColorBackground(black_);
    } //!flapperons &&
    ...
    // Body  
    line(0, 1.5f * scalesize, -5, -2, -0.5f * scalesize, -5);
    line(0, 1.5f * scalesize, -5, 2, -0.5f * scalesize, -5);
    line(-2, -0.5f * scalesize, -5, 2, -0.5f * scalesize, -5);
    // Fin 
    float finpos = scalesize * 1.3f;
    int HFin = 0;
    int LFin = 15;
    line(0, finpos - 3, 0, 0, finpos + 7, -LFin);
    line(0, finpos + 7, -LFin, 0, finpos + 10, -LFin);
    line(0, finpos + 10, -LFin, 0, finpos + 5, 0);
    line(0, finpos - 3, 0, 0, finpos, HFin);
    line(0, finpos, HFin, 0, finpos + 5, HFin);
    line(0, finpos + 5, HFin, 0, finpos + 5, 0);

    // Stab
    line(-(scalesize * 0.3f), scalesize, -5, (scalesize * 0.3f), scalesize, -5);
    line(-(scalesize * 0.3f), scalesize + 3, -5, (scalesize * 0.3f), scalesize + 3, -5);
    line(-(scalesize * 0.3f), scalesize, -5, -(scalesize * 0.3f), scalesize + 3, -5);
    line((scalesize * 0.3f), scalesize, -5, (scalesize * 0.3f), scalesize + 3, -5);
    ...
    BtServo[4].setLabel("  \u526f\u7ffc").setSize(60, 12);
    BtServo[5].setLabel("  YAW");
    ...
    ellipse(0, 0, 2 * scalesize, 2 * scalesize);
    // Body  
    line(0, 1.5f * scalesize, -2, -0.5f * scalesize);
    line(0, 1.5f * scalesize, 2, -0.5f * scalesize);
    line(-2, -0.5f * scalesize, 2, -0.5f * scalesize);
    // Fin 
    float finpos = scalesize * 1.3f;
    int HFin = 5;
    int LFin = 10;
    ...
    // Stab
    line(-(scalesize * 0.3f), scalesize, (scalesize * 0.3f), scalesize);
    line(-(scalesize * 0.3f), scalesize + 3, (scalesize * 0.3f), scalesize + 3);
    line(-(scalesize * 0.3f), scalesize, -(scalesize * 0.3f), scalesize + 3);
    line((scalesize * 0.3f), scalesize, (scalesize * 0.3f), scalesize + 3);
    ...
    servoSliderV[4].setPosition(xMot + 120, yMot - 15).setCaptionLabel("\u526f\u7ffc").show();
    ...
    int ind = -5;
    for (i = 0; i < 8; i++) {
      servoSliderH[i].setPosition(xMot, yMot + ind).setCaptionLabel("CH " + (i + 1)).show();
    ...
    servoSliderH[4].setPosition(xMot, yMot + 55).setCaptionLabel("\u5347\u964d\u8235").show();
    servoSliderH[5].setPosition(xMot, yMot + 25).setCaptionLabel("\u526f\u7ffc").show();
  ...
  strokeWeight(4);
  stroke(255, 255, 100);
  line(0, 0, 0, -2.4f * size);
  line(0, -2.4f * size, -5, -2.4f * size + 10);
  line(0, -2.4f * size, +5, -2.4f * size + 10);
  rotate(-GPS_directionToHome * PI / 180);
  // compass quadrant
  strokeWeight(1.5f);
  ...
  stroke(255);
  rotate(head * PI / 180);
  line(0, size * 0.2f, 0, -size * 1.3f);
  line(0, -size * 1.3f, -5, -size * 1.3f + 10);
  line(0, -size * 1.3f, +5, -size * 1.3f + 10);
  popMatrix();
  // angles 
  for (i = 0; i <= 12; i++) {
  ...
  textFont(font15);
  text("N", xCompass - 5, yCompass - 22 - size * 0.9f);
  text("S", xCompass - 5, yCompass + 32 + size * 0.9f);
  text("W", xCompass - 33 - size * 0.9f, yCompass + 6);
  text("E", xCompass + 21 + size * 0.9f, yCompass + 6);
  // head indicator
  textFont(font12);
  noStroke();
  fill(80, 80, 80, 130);
  ...
  if (azGraph) {
    if (scaleSlider.value() < 2) {
      g_graph.drawLine(accYAW, -1000, +1000);
    } else {
      g_graph.drawLine(accYAW, 200 * scaleSlider.value() - 1000, 200 * scaleSlider.value() + 500);
    }
  }
  ...
  stroke(125, 125, 125);
  if (altGraph) g_graph.drawLine(altData, altMin, altMax);
  stroke(225, 225, 125);
  if (headGraph) g_graph.drawLine(headData, -370, +370);
  stroke(50, 100, 150);
  if (magxGraph) g_graph.drawLine(magxData, -500, +500);
  stroke(100, 50, 150);
  if (magyGraph) g_graph.drawLine(magyData, -500, +500);
  stroke(150, 100, 50);
  if (magzGraph) g_graph.drawLine(magzData, -500, +500);
  ...
  if (!hideDraw) {
    ...
    fill(255);
    textFont(font15);
    text("P", xParam + 45, yParam + 15);
    text("I", xParam + 90, yParam + 15);
    text("D", xParam + 130, yParam + 15);
    textFont(font8);
    text("\u5347\u964d\u8235", xSens1 + 2, ySens1 + 10);
    text("\u526f\u7ffc", xSens1 + 2, ySens1 + 20);
    text("\u6cb9\u95e8", xSens2 + 2, ySens2 + 10);
    textFont(font12);
    text("\u901f\u7387", xParam + 3, yParam + 232);
    text("EXPO", xParam + 3, yParam + 249);
    text("MID", xParam + 3, yParam + 193);
    text("EXPO", xParam + 3, yParam + 210);
    text("RATE", xParam + 160, yParam + 15);
    text("\u526f\u7ffc", xParam + 3, yParam + 32);
    text("\u5347\u964d\u8235", xParam + 3, yParam + 32 + 1 * 17);
    text("\u65b9\u5411\u8235", xParam + 3, yParam + 32 + 2 * 17);
    ...
    text("\u81ea\u7a33\u529f\u80fd", xParam + 1, yParam + 32 + 7 * 17);
    text("\u822a\u7ebf\u9501\u5b9a", xParam + 3, yParam + 32 + 8 * 17);
    text("T P A", xParam + 215, yParam + 15);

    text("\u901a\u90531", xBox + 55, yBox + 5);
    text("\u901a\u90532", xBox + 105, yBox + 5);
    text("\u901a\u90533", xBox + 165, yBox + 5);
    text("\u901a\u90534", xBox + 218, yBox + 5);
    textFont(font8);
    text("\u4f4e", xBox + 37, yBox + 15);
    text("\u4e2d", xBox + 57, yBox + 15);
    text("\u9ad8", xBox + 74, yBox + 15);
    text("\u4f4e", xBox + 100, yBox + 15);
    text("\u4e2d", xBox + 118, yBox + 15);
    text("\u9ad8", xBox + 136, yBox + 15);
    text("\u4f4e", xBox + 154, yBox + 15);
    text("\u4e2d", xBox + 174, yBox + 15);
    text("\u9ad8", xBox + 194, yBox + 15);
    text("\u4f4e", xBox + 212, yBox + 15);
    text("\u4e2d", xBox + 232, yBox + 15);
    text("\u9ad8", xBox + 252, yBox + 15);
  }
  pushMatrix();
  translate(0, 0, 0);
  popMatrix();
  if (versionMisMatch == 1) {
    textFont(font15);
    fill(0xff000000);
    text("GUI vs. Arduino: Version or Buffer size mismatch", 180, 420); 
    return;
  }
}
...
public void ACC_ROLL(boolean theFlag) {
  axGraph = theFlag;
}
public void ACC_PITCH(boolean theFlag) {
  ayGraph = theFlag;
}
public void ACC_Z(boolean theFlag) {
  azGraph = theFlag;
}
public void GYRO_ROLL(boolean theFlag) {
  gxGraph = theFlag;
}
public void GYRO_PITCH(boolean theFlag) {
  gyGraph = theFlag;
}
public void GYRO_YAW(boolean theFlag) {
  gzGraph = theFlag;
}
public void BARO(boolean theFlag) {
  altGraph = theFlag;
}
public void HEAD(boolean theFlag) {
  headGraph = theFlag;
}
public void MAGX(boolean theFlag) {
  magxGraph = theFlag;
}
public void MAGY(boolean theFlag) {
  magyGraph = theFlag;
}
public void MAGZ(boolean theFlag) {
  magzGraph = theFlag;
}
public void DEBUG1(boolean theFlag) {
  debug1Graph = theFlag;
}
public void DEBUG2(boolean theFlag) {
  debug2Graph = theFlag;
}
public void DEBUG3(boolean theFlag) {
  debug3Graph = theFlag;
}
public void DEBUG4(boolean theFlag) {
  debug4Graph = theFlag;
}
...
public void controlEvent(ControlEvent theEvent) {
  ...
  if (theEvent.isGroup())
    if (theEvent.name() == "baudList") GUI_BaudRate = (int)(theEvent.group().value()); // Set GUI_BaudRate to selected.
  if (theEvent.isTab()) {
    ActiveTab = theEvent.getTab().getName();
    println("Switched to: " + ActiveTab);
    ...
    if (!Mag_) confINF[6].hide();
    if (tabN != 3) {
      txtlblWhichcom.moveTo(ActiveTab);
      commListbox.moveTo(ActiveTab);
    }
    ...
    if (tabN == 1) {
      ...
      hideDraw = true;
    } // Hide grapics in all other tabs
    if (tabN == 4) {
...
public void SAVE_SERVO_CONFIG() { // Save a config file for servos
  ...
  output.print("#define  SERVO_MIN  {");
  for (i = 0; i < 7; i++) {
    output.print(ServoMIN[i]);
    output.print(", ");
  }
  output.print(ServoMIN[7]);
  output.println("}");
  output.print("#define  SERVO_MAX  {");
  for (i = 0; i < 7; i++) {
    output.print(ServoMAX[i]);
    output.print(", ");
  }
  output.print(ServoMAX[7]);
  output.println("}");
  output.print("#define  SERVO_MID  {");
  for (i = 0; i < 7; i++) {
    output.print(ServoMID[i]);
    output.print(", ");
  }
  output.print(ServoMID[7]);
  output.println("}");
  output.print("#define  FORCE_SERVO_RATES  {");
  for (i = 0; i < 7; i++) {
    output.print(servoRATE[i]);
    output.print(", ");
  }
  output.print(servoRATE[7]);
  output.println("}");
  output.flush(); // Writes the remaining data to the file
  output.close(); // Finishes the file
  buttonExport.hide();
...
public void Cau0() {
  ServoSliderC[2].setMin(4).setMax(10).setValue(4);
  CauClear();
  BtAUX[0].setColorBackground(orange_);
}
public void Cau1() {
  ServoSliderC[2].setMin(4).setMax(10).setValue(5);
  CauClear();
  BtAUX[1].setColorBackground(orange_);
}
public void Cau2() {
  ServoSliderC[2].setMin(4).setMax(10).setValue(6);
  CauClear();
  BtAUX[2].setColorBackground(orange_);
}
public void Cau3() {
  ServoSliderC[2].setMin(4).setMax(10).setValue(7);
  CauClear();
  BtAUX[3].setColorBackground(orange_);
}
public void Cau4() {
  ServoSliderC[2].setMin(Centerlimits[0]).setMax(Centerlimits[1]).setValue(1500);
  CauClear();
}
public void CauClear() {
  for (i = 0; i < 4; i++) BtAUX[i].setColorBackground(red_);
}
...
// WebLinks
public void MagDecl() {
  link("http://magnetic-declination.com/");
}
public void MWiiHome() {
  link("http://multiwii.com/forum/");
}
public void MWiiGet() {
  link("https://code.google.com/p/multiwii/downloads/list");
}
...
public void Tooltips() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "MultiWiiConf" };
    if (passedArgs != null) {
